#!/usr/bin/env python
"""
Experiment: Causal Ablation of Pair Bias B — 200M model (notri)
================================================================
...
EXPERIMENT_NAME = "2026-03-15-bias-ablation-200m"
...
def save_summary(all_results: dict):
    ...
    with open(summary_path, "w") as f:
        ...
        f.write(f"Model: 200M (notri), n={PROTEIN_LENGTH}, seeds={SEEDS}\n\n")
